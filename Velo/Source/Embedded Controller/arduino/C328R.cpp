...
* @return True if successful, false otherwise.
*/
bool C328R::initial( ColorType colorType, PreviewResolution previewResolution, JPEGResolution jpegResolution )
{
...
* @return True if successful, false otherwise
*/
bool C328R::setLightFrequency( FrequencyType frequencyType )
{
...
* @return True if successful, false otherwise
*/
bool C328R::setPackageSize( uint16_t size )
{
...
* @return True if successful, false otherwise
*/
bool C328R::snapshot( SnapshotType snapshotType, uint16_t skipFrames )
{
...
* @return True if successful, false otherwise
*/
bool C328R::getJPEGPicture( PictureType pictureType, uint16_t processDelay, void (*callback)( uint16_t picSize, uint16_t packPicDataSize, uint16_t packCount, byte* pack))
{
...
* @return True if successful, false otherwise
*/
bool C328R::reset( bool completeReset )
{
...
* @return True if successful, false otherwise
*/
bool C328R::setBaudRate( BaudRate baudRate )
{
...
* @return True if successful, false otherwise
*/
bool C328R::getRawPicture( PictureType pictureType, byte pictureBuffer[], uint16_t &bufferSize, uint16_t processDelay )
{
	uint16_t pictureSize = 0;
...
*/
bool C328R::getPicture( PictureType pictureType, uint16_t processDelay, uint16_t &pictureSize )
{
	pictureSize = 0;
...
*/
bool C328R::waitForACK( uint32_t timeout, uint8_t cmdId )
{
...
*/
void C328R::sendCommand()
{
	uint8_t i;

	for( i = 0; i < CMD_SIZE; i++ )
	{
		Serial2.print( _command[i], BYTE );
	}
}
...
*/
void C328R::createCommand( const byte cmd, byte param1, byte param2, byte param3, byte param4 )
{
...
* Sends and ACK.
*/
void C328R::sendACK( const byte cmd )
{
	sendACK( cmd, 0 );
}
...
*/
void C328R::sendACK( const byte cmd, uint16_t packageId )
{
...
*/
bool C328R::waitForResponse( uint32_t timeout )
{
...
* @return True if response received, false otherwise
*/
bool C328R::waitForResponse( uint32_t timeout, byte buffer[], uint16_t bufferLength )
{
	uint8_t byteCnt = 0;
