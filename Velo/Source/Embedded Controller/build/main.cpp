...
int ECU(void)
{
    //      5V 
    // ------------ * read steps
    //  1204 steps                = 0.0766653
    //---------------------------
    //          63.69mV
    cAnalog Voltage(VOLTAGE_PIN, 0.0766653);
    ...
    //---------------------------
    //          36.60mA
    cAnalog Current(CURRENT_PIN, 0.13341);

    //    100%
    //------------ = 0.09765625
    // 1024 steps
    cAnalog Throttle(THROTTLE_PIN, 0.09765625)

    //Power in Watts
    watts = Voltage.Scale() * Current.Scale();
}
