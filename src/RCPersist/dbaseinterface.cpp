	...
	int charge)
{
	...
	string query = "INSERT INTO BMS (AvgVolts, AvgAmps, AvgResist, Charge, AvgTemp, trip_id) VALUES( ";
...
void DBaseInterface::GPSInsert(int direction,
	double latitude,
	double longitude,
	float speed)
{
	...
	string query = "INSERT INTO GPS_DATA (trip_id, Longitude, Lattitude, speed, bearing) VALUES((select MAX(trip_id) from trip),";
